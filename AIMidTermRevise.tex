...
A \textbf{genetic algorithm} (GA) is a variant of stochastic beam search were successors are generated by two \emph{parent} states rather than by modifying a single state.
We start with a \textbf{population} of $k$ randomly generated states.
